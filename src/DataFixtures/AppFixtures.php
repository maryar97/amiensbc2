...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        ->setMail('enzo.cmery1704@gmail.com')
        ->setPhoto('1.jpg')
        ->setSexe('h')
        ...
        $Formedeboxe3->setNom('boxe professionnelle')
