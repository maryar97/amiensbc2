...
return [
    ...
    'cart_add' => [['id'], ['_controller' => 'App\\Controller\\CartController::addToRoute'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/mon-panier/add']], [], [], []],
    ...
    'app_formedeboxe_detail' => [['id'], ['_controller' => 'App\\Controller\\FormedeboxeController::detail'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/detail']], [], [], []],
    ...
    'App\Controller\CartController::addToRoute' => [['id'], ['_controller' => 'App\\Controller\\CartController::addToRoute'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/mon-panier/add']], [], [], []],
    ...
    'App\Controller\FormedeboxeController::detail' => [['id'], ['_controller' => 'App\\Controller\\FormedeboxeController::detail'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/detail']], [], [], []],
