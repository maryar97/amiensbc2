    ...
    <div class=\"card-body\">
     <img src=\"image/23.png\" alt=\"\" width=\"100px\">
      ...
      <a href=\"";
        ...
        echo "\" class=\"btn btn-primary\">bureau</a>
    </div>
  </div>
  ...
  <div class=\"card text-center mb-3\" style=\"width: 18rem;\">
    <div class=\"card-body\">
      ...
      <a href=\"";
        ...
        echo "\" class=\"btn btn-primary\">horaire/tarif</a>
    </div>
  </div>
  ...
  <div class=\"card text-end\" style=\"width: 18rem;\">
    <div class=\"card-body\">
      ...
      <a href=\"";
        ...
        echo "\" class=\"btn btn-primary\">forme de boxe</a>
    </div>
  </div>
</div>
...
<div class=\"bea\">
  ...
  <div class=\"card mb-3\" style=\"width: 18rem;\">
    <div class=\"card-body\">
     <img src=\"image/23.png\" alt=\"\" width=\"100px\">
      <p class=\"card-text\">presentation du bureau</p>
      <a href=\"{{path(\"app_club\")}}\" class=\"btn btn-primary\">bureau</a>
    </div>
  </div>
  ...
  <div class=\"card text-center mb-3\" style=\"width: 18rem;\">
    <div class=\"card-body\">
      <img src=\"image/24.png\" alt=\"\" width=\"100px\">
      <p class=\"card-text\">information des heures d'ouverture</p>
      <a href=\"{{path(\"app_horaire\")}}\" class=\"btn btn-primary\">horaire/tarif</a>
    </div>
  </div>
  ...
  <div class=\"card text-end\" style=\"width: 18rem;\">
    <div class=\"card-body\">
      <img src=\"image/24.png\" alt=\"\" width=\"100px\">
      <p class=\"card-text\">presentation des  activité proposé</p>
      <a href=\"{{path(\"app_formedeboxe\")}}\" class=\"btn btn-primary\">forme de boxe</a>
    </div>
  </div>
</div>

{% endblock %}
", "accueil/index.html.twig", "/home/mary/Documents/amiensbc/templates/accueil/index.html.twig");
    }
}
